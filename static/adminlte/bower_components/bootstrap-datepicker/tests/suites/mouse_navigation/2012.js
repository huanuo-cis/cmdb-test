...
test('Selecting data from previous month resets viewDate and data, changing month displayed', function(){
    var target;
...
test('Selecting data from next month resets viewDate and data, changing month displayed', function(){
    var target;
