...
test('Selecting data from previous month while in January changes month and year displayed', function(){
    var target;
...
test('Selecting data from next month while in December changes month and year displayed', function(){
    var target;
