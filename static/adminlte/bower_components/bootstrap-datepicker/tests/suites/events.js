...
test('format() returns a formatted data string', function(){
    var target,
        error, out;
...
test('format(altformat) returns a formatted data string', function(){
    var target,
        error, out;
...
test('format(ix) returns a formatted data string of the ix\'th data selected', function(){
    var target,
        error, out;
...
test('format(ix, altformat) returns a formatted data string', function(){
    var target,
        error, out;
...
test('paste must update the data', function() {
...
test('Selecting data from previous month triggers changeMonth', function() {
    var target,
        triggered = 0;
...
test('Selecting data from previous month in january triggers changeMonth/changeYear', function() {
    var target,
        triggeredM = 0,
        triggeredY = 0;
...
test('Selecting data from next month triggers changeMonth', function() {
    var target,
        triggered = 0;
...
test('Selecting data from next month in december triggers changeMonth/changeYear', function() {
    var target,
        triggeredM = 0,
        triggeredY = 0;
...
test('Clicking inside content of data with custom beforeShowDay content works', function(){
    this.input = $('<input type="text" value="31-03-2011">')
                    .appendTo('#qunit-fixture')
                    .datepicker({
                        format: "dd-mm-yyyy",
