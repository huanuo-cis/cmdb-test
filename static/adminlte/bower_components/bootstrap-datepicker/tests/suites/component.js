module('Component', {
    setup: function(){
        this.component = $('<div class="input-append data" id="datepicker">'+
...
test('Component gets data/viewDate from input value', function(){
...
test('Selecting data resets viewDate and data', function(){
    var target;
...
test('data and viewDate must be between startDate and endDate when setStartDate called', function() {
...
test('data and viewDate must be between startDate and endDate when setEndDate called', function() {
